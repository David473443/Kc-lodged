          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div>
              ...
              <FadeInView delay={0.4}>
                <div className="border border-stone-400/50 p-7 mb-10 bg-stone-300/45 shadow-[var(--shadow-xs)]">
                  <p className="text-sky-700 text-[10px] tracking-[0.35em] uppercase mb-6 font-sans font-semibold">
                    Opening Hours
                  </p>
                  <ul className="space-y-5">
                    {hours.map(({ meal, time }) => (
                      <li key={meal} className="flex justify-between items-center">
                        <span className="text-slate text-sm font-sans tracking-wide">{meal}</span>
                        <div className="h-px flex-1 mx-5 bg-stone-300" />
                        <span className="font-serif text-navy text-lg font-light">{time}</span>
                      </li>
                    ))}
                  </ul>
                </div>
            ...
            <FadeInView direction="right">
              <div className="relative h-[580px] overflow-hidden shadow-[var(--shadow-lg)]">
                ...
                {/* Corner frames */}
                <div className="absolute inset-5 border border-sky-200/30 pointer-events-none z-10" />
                ...
                <div className="absolute bottom-10 left-8 z-20">
                  <p className="font-script text-gold-light text-4xl leading-none">The Lobby</p>
