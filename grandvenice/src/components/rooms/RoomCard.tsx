...
export function RoomCard({ room }: RoomCardProps) {
  ...
  return (
    <div className="luxury-card group relative flex flex-col overflow-hidden bg-white border border-grey-200 hover:border-sky-300 transition-colors duration-500">
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-grey-200 mt-auto">
          <Link
